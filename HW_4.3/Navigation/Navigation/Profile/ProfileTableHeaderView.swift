...
//  Navigation
//
//  Created by Simon Pegg on 04.09.2021.
//
...
class ProfileTableHeaderView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        [
            ...
            avatarImageView.bottomAnchor.constraint(equalTo: safeAreaLayoutGuide.topAnchor  ,constant: 107+16),
            
            fullNameLabel.leadingAnchor.constraint(equalTo: avatarImageView.trailingAnchor ,constant: 16),
            fullNameLabel.trailingAnchor.constraint(equalTo: trailingAnchor ,constant: -16),
            fullNameLabel.topAnchor.constraint(equalTo: safeAreaLayoutGuide.topAnchor ,constant: 27),
            fullNameLabel.bottomAnchor.constraint(equalTo: safeAreaLayoutGuide.topAnchor ,constant: 27+23),
            ...
            statusTextField.bottomAnchor.constraint(equalTo: statusLabel.bottomAnchor ,constant: 50),
            
            setStatusButton.leadingAnchor.constraint(equalTo: leadingAnchor,constant: 16),
            setStatusButton.trailingAnchor.constraint(equalTo: trailingAnchor ,constant: -16),
            setStatusButton.topAnchor.constraint(equalTo: statusTextField.bottomAnchor,constant: 10),
            setStatusButton.bottomAnchor.constraint(equalTo: setStatusButton.topAnchor ,constant: 50),
        ]
        .forEach {
            $0.isActive = true
        }
